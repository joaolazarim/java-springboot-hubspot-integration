...
public class HubSpotContactService {
    ...
    private static final Logger logger = LoggerFactory.getLogger(HubSpotContactService.class);

    private final RestTemplate restTemplate;
    private final HubSpotProperties hubSpotProperties;

    public HubSpotContactService(RestTemplate restTemplate, HubSpotProperties hubSpotProperties) {
